...
| **DeepSeek Coder & R1/V3** | **[deepseek-ai/DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)** | `main` (2026-09-01)<br>*持续演进与功能迭代* | 超长上下文推理链、强化学习因果重构与极限推理成本 | 白泽首发支持 DeepSeek V3/R1 思维链结构化强制 (<thinking>) 与 AST 语义剪枝（Token 压缩比按调用实测，非固定比例）。 |
