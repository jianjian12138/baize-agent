...
[![Tests](https://img.shields.io/badge/tests-1332%2F1335%20passed%20(100%25)-brightgreen?style=for-the-badge)](https://github.com/jianjian12138/baize-agent)
...
| 分支 | 内容 | 状态 |
| :--- | :--- | :--- |
| **`v30-dev`** | V30 → V37.0.0 Prometheus 线：Ralph 自主 PRD 状态机、全球智能雷达、Swarm 影子推演、票数门槛仲裁、桌面 Studio | **默认分支 · 活跃开发** |
